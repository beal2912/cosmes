...
import { DEXSettings, Token, TokenUpgradeStatuses } from "./token_pb.js";
...
export class QueryBalanceResponse extends Message<QueryBalanceResponse> {
  ...
  /**
   * @generated from field: string expected_to_receive_in_dex = 7;
   */
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 5, name: "locked_in_vesting", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 6, name: "locked_in_dex", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 7, name: "expected_to_receive_in_dex", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);
 ...
 */
export class QueryDEXSettingsRequest extends Message<QueryDEXSettingsRequest> {
  /**
  ...
  constructor(data?: PartialMessage<QueryDEXSettingsRequest>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "coreum.asset.ft.v1.QueryDEXSettingsRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "denom", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): QueryDEXSettingsRequest {
    return new QueryDEXSettingsRequest().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): QueryDEXSettingsRequest {
    return new QueryDEXSettingsRequest().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): QueryDEXSettingsRequest {
    return new QueryDEXSettingsRequest().fromJsonString(jsonString, options);
  }

  static equals(a: QueryDEXSettingsRequest | PlainMessage<QueryDEXSettingsRequest> | undefined, b: QueryDEXSettingsRequest | PlainMessage<QueryDEXSettingsRequest> | undefined): boolean {
    return proto3.util.equals(QueryDEXSettingsRequest, a, b);
  }
}
 ...
 */
export class QueryDEXSettingsResponse extends Message<QueryDEXSettingsResponse> {
  /**
  ...
  constructor(data?: PartialMessage<QueryDEXSettingsResponse>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "coreum.asset.ft.v1.QueryDEXSettingsResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "dex_settings", kind: "message", T: DEXSettings },
  ]);

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): QueryDEXSettingsResponse {
    return new QueryDEXSettingsResponse().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): QueryDEXSettingsResponse {
    return new QueryDEXSettingsResponse().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): QueryDEXSettingsResponse {
    return new QueryDEXSettingsResponse().fromJsonString(jsonString, options);
  }

  static equals(a: QueryDEXSettingsResponse | PlainMessage<QueryDEXSettingsResponse> | undefined, b: QueryDEXSettingsResponse | PlainMessage<QueryDEXSettingsResponse> | undefined): boolean {
    return proto3.util.equals(QueryDEXSettingsResponse, a, b);
  }
}
