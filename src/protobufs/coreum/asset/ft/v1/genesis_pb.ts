...
import { DEXSettings, Token } from "./token_pb.js";
...
export class GenesisState extends Message<GenesisState> {
  ...
  /**
   * @generated from field: repeated coreum.asset.ft.v1.Balance dex_expected_to_receive_balances = 7;
   */
  dexExpectedToReceiveBalances: Balance[] = [];

  /**
   * @generated from field: repeated coreum.asset.ft.v1.DEXSettingsWithDenom dex_settings = 8;
   */
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 6, name: "dex_locked_balances", kind: "message", T: Balance, repeated: true },
    { no: 7, name: "dex_expected_to_receive_balances", kind: "message", T: Balance, repeated: true },
    { no: 8, name: "dex_settings", kind: "message", T: DEXSettingsWithDenom, repeated: true },
  ]);
 ...
 */
export class DEXSettingsWithDenom extends Message<DEXSettingsWithDenom> {
  /**
   * @generated from field: string denom = 1;
   */
  denom = "";
  ...
  constructor(data?: PartialMessage<DEXSettingsWithDenom>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "coreum.asset.ft.v1.DEXSettingsWithDenom";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "denom", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "dex_settings", kind: "message", T: DEXSettings },
  ]);

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): DEXSettingsWithDenom {
    return new DEXSettingsWithDenom().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): DEXSettingsWithDenom {
    return new DEXSettingsWithDenom().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): DEXSettingsWithDenom {
    return new DEXSettingsWithDenom().fromJsonString(jsonString, options);
  }

  static equals(a: DEXSettingsWithDenom | PlainMessage<DEXSettingsWithDenom> | undefined, b: DEXSettingsWithDenom | PlainMessage<DEXSettingsWithDenom> | undefined): boolean {
    return proto3.util.equals(DEXSettingsWithDenom, a, b);
  }
}
