...
import { DataDynamicIndexedItem } from "./types_pb.js";
 ...
 */
export class MsgUpdateData extends Message<MsgUpdateData> {
  /**
   * @generated from field: string sender = 1;
   */
  sender = "";
  ...
  constructor(data?: PartialMessage<MsgUpdateData>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "coreum.asset.nft.v1.MsgUpdateData";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "sender", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "class_id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 3, name: "id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 4, name: "items", kind: "message", T: DataDynamicIndexedItem, repeated: true },
  ]);

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): MsgUpdateData {
    return new MsgUpdateData().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): MsgUpdateData {
    return new MsgUpdateData().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): MsgUpdateData {
    return new MsgUpdateData().fromJsonString(jsonString, options);
  }

  static equals(a: MsgUpdateData | PlainMessage<MsgUpdateData> | undefined, b: MsgUpdateData | PlainMessage<MsgUpdateData> | undefined): boolean {
    return proto3.util.equals(MsgUpdateData, a, b);
  }
}
