...
// @generated from file noble/dollar/v2/dollar.proto (package noble.dollar.v2, syntax proto3)
/* eslint-disable */
// @ts-nocheck
...
/**
 * @generated from enum noble.dollar.v2.Provider
 */
export enum Provider {
  /**
   * @generated from enum value: IBC = 0;
   */
  IBC = 0,

  /**
   * @generated from enum value: HYPERLANE = 1;
   */
  HYPERLANE = 1,
}
// Retrieve enum metadata with: proto3.getEnumType(Provider)
proto3.util.setEnumType(Provider, "noble.dollar.v2.Provider", [
  { no: 0, name: "IBC" },
  { no: 1, name: "HYPERLANE" },
]);
 ...
 *
 * @generated from message noble.dollar.v2.Stats
 */
export class Stats extends Message<Stats> {
  ...
  static readonly typeName = "noble.dollar.v2.Stats";
