...
// @generated from file atomone/gov/v1beta1/gov.proto (package atomone.gov.v1beta1, syntax proto3)
/* eslint-disable */
// @ts-nocheck
 ...
 *
 * @generated from enum atomone.gov.v1beta1.VoteOption
 */
...
proto3.util.setEnumType(VoteOption, "atomone.gov.v1beta1.VoteOption", [
 ...
 *
 * @generated from enum atomone.gov.v1beta1.ProposalStatus
 */
...
proto3.util.setEnumType(ProposalStatus, "atomone.gov.v1beta1.ProposalStatus", [
 ...
 *
 * @generated from message atomone.gov.v1beta1.WeightedVoteOption
 */
export class WeightedVoteOption extends Message<WeightedVoteOption> {
   ...
   * options.
   *
   * @generated from field: atomone.gov.v1beta1.VoteOption option = 1;
   */
  ...
  static readonly typeName = "atomone.gov.v1beta1.WeightedVoteOption";
 ...
 *
 * @generated from message atomone.gov.v1beta1.TextProposal
 */
export class TextProposal extends Message<TextProposal> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "atomone.gov.v1beta1.TextProposal";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 * proposal.
 *
 * @generated from message atomone.gov.v1beta1.Deposit
 */
export class Deposit extends Message<Deposit> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "atomone.gov.v1beta1.Deposit";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message atomone.gov.v1beta1.Proposal
 */
export class Proposal extends Message<Proposal> {
   ...
   *
   * @generated from field: atomone.gov.v1beta1.ProposalStatus status = 3;
   */
   ...
   *
   * @generated from field: atomone.gov.v1beta1.TallyResult final_tally_result = 4;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "atomone.gov.v1beta1.Proposal";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "proposal_id", kind: "scalar", T: 4 /* ScalarType.UINT64 */ },
 ...
 *
 * @generated from message atomone.gov.v1beta1.TallyResult
 */
export class TallyResult extends Message<TallyResult> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "atomone.gov.v1beta1.TallyResult";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message atomone.gov.v1beta1.Vote
 */
export class Vote extends Message<Vote> {
   ...
   *
   * @generated from field: atomone.gov.v1beta1.VoteOption option = 3 [deprecated = true];
   * @deprecated
   */
  option = VoteOption.UNSPECIFIED;
   ...
   * Since: cosmos-sdk 0.43
   *
   * @generated from field: repeated atomone.gov.v1beta1.WeightedVoteOption options = 4;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "atomone.gov.v1beta1.Vote";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "proposal_id", kind: "scalar", T: 4 /* ScalarType.UINT64 */ },
 ...
 *
 * @generated from message atomone.gov.v1beta1.DepositParams
 */
export class DepositParams extends Message<DepositParams> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "atomone.gov.v1beta1.DepositParams";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message atomone.gov.v1beta1.VotingParams
 */
export class VotingParams extends Message<VotingParams> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "atomone.gov.v1beta1.VotingParams";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message atomone.gov.v1beta1.TallyParams
 */
export class TallyParams extends Message<TallyParams> {
   ...
   * considered valid.
   *
   * @generated from field: bytes quorum = 1 [deprecated = true];
   * @deprecated
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "atomone.gov.v1beta1.TallyParams";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
