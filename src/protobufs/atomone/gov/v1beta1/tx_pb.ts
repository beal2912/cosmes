...
// @generated from file atomone/gov/v1beta1/tx.proto (package atomone.gov.v1beta1, syntax proto3)
/* eslint-disable */
// @ts-nocheck
 ...
 * proposal Content.
 *
 * @generated from message atomone.gov.v1beta1.MsgSubmitProposal
 */
export class MsgSubmitProposal extends Message<MsgSubmitProposal> {
  ...
  static readonly typeName = "atomone.gov.v1beta1.MsgSubmitProposal";
 ...
 *
 * @generated from message atomone.gov.v1beta1.MsgSubmitProposalResponse
 */
export class MsgSubmitProposalResponse extends Message<MsgSubmitProposalResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "atomone.gov.v1beta1.MsgSubmitProposalResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message atomone.gov.v1beta1.MsgVote
 */
export class MsgVote extends Message<MsgVote> {
   ...
   *
   * @generated from field: atomone.gov.v1beta1.VoteOption option = 3;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "atomone.gov.v1beta1.MsgVote";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "proposal_id", kind: "scalar", T: 4 /* ScalarType.UINT64 */ },
 ...
 *
 * @generated from message atomone.gov.v1beta1.MsgVoteResponse
 */
export class MsgVoteResponse extends Message<MsgVoteResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "atomone.gov.v1beta1.MsgVoteResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ]);
 ...
 *
 * @generated from message atomone.gov.v1beta1.MsgVoteWeighted
 */
export class MsgVoteWeighted extends Message<MsgVoteWeighted> {
   ...
   *
   * @generated from field: repeated atomone.gov.v1beta1.WeightedVoteOption options = 3;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "atomone.gov.v1beta1.MsgVoteWeighted";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "proposal_id", kind: "scalar", T: 4 /* ScalarType.UINT64 */ },
    { no: 2, name: "voter", kind: "scalar", T: 9 /* ScalarType.STRING */ },
 ...
 * Since: cosmos-sdk 0.43
 *
 * @generated from message atomone.gov.v1beta1.MsgVoteWeightedResponse
 */
export class MsgVoteWeightedResponse extends Message<MsgVoteWeightedResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "atomone.gov.v1beta1.MsgVoteWeightedResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ]);
 ...
 *
 * @generated from message atomone.gov.v1beta1.MsgDeposit
 */
export class MsgDeposit extends Message<MsgDeposit> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "atomone.gov.v1beta1.MsgDeposit";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "proposal_id", kind: "scalar", T: 4 /* ScalarType.UINT64 */ },
 ...
 *
 * @generated from message atomone.gov.v1beta1.MsgDepositResponse
 */
export class MsgDepositResponse extends Message<MsgDepositResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "atomone.gov.v1beta1.MsgDepositResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ]);
