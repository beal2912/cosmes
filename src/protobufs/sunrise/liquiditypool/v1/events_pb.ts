...
// @generated from file sunrise/liquiditypool/v1/events.proto (package sunrise.liquiditypool.v1, syntax proto3)
/* eslint-disable */
// @ts-nocheck
 ...
 * EventCreatePool
 *
 * @generated from message sunrise.liquiditypool.v1.EventCreatePool
 */
export class EventCreatePool extends Message<EventCreatePool> {
  ...
  static readonly typeName = "sunrise.liquiditypool.v1.EventCreatePool";
 ...
 * EventCreatePosition
 *
 * @generated from message sunrise.liquiditypool.v1.EventCreatePosition
 */
export class EventCreatePosition extends Message<EventCreatePosition> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "sunrise.liquiditypool.v1.EventCreatePosition";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message sunrise.liquiditypool.v1.EventIncreaseLiquidity
 */
export class EventIncreaseLiquidity extends Message<EventIncreaseLiquidity> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "sunrise.liquiditypool.v1.EventIncreaseLiquidity";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message sunrise.liquiditypool.v1.EventDecreaseLiquidity
 */
export class EventDecreaseLiquidity extends Message<EventDecreaseLiquidity> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "sunrise.liquiditypool.v1.EventDecreaseLiquidity";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "position_id", kind: "scalar", T: 4 /* ScalarType.UINT64 */ },
    { no: 2, name: "address", kind: "scalar", T: 9 /* ScalarType.STRING */ },
 ...
 * EventClaimRewards
 *
 * @generated from message sunrise.liquiditypool.v1.EventClaimRewards
 */
export class EventClaimRewards extends Message<EventClaimRewards> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "sunrise.liquiditypool.v1.EventClaimRewards";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message sunrise.liquiditypool.v1.EventSwapExactAmountIn
 */
export class EventSwapExactAmountIn extends Message<EventSwapExactAmountIn> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "sunrise.liquiditypool.v1.EventSwapExactAmountIn";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "address", kind: "scalar", T: 9 /* ScalarType.STRING */ },
...
export class EventSwapExactAmountOut extends Message<EventSwapExactAmountOut> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "sunrise.liquiditypool.v1.EventSwapExactAmountOut";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "address", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "pool_id", kind: "scalar", T: 4 /* ScalarType.UINT64 */ },
    { no: 3, name: "token_in", kind: "message", T: Coin },
