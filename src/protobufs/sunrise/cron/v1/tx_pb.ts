...
export class MsgUpdateParams extends Message<MsgUpdateParams> {
   ...
   *
   * @generated from field: sunrise.cron.v1.Params params = 2;
   */
  params?: Params;
  ...
  static readonly typeName = "sunrise.cron.v1.MsgUpdateParams";
 ...
 *
 * @generated from message sunrise.cron.v1.MsgUpdateParamsResponse
 */
export class MsgUpdateParamsResponse extends Message<MsgUpdateParamsResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "sunrise.cron.v1.MsgUpdateParamsResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ]);
 ...
 *
 * @generated from message sunrise.cron.v1.MsgAddSchedule
 */
export class MsgAddSchedule extends Message<MsgAddSchedule> {
   ...
   *
   * @generated from field: repeated sunrise.cron.v1.MsgExecuteContract msgs = 4;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "sunrise.cron.v1.MsgAddSchedule";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "authority", kind: "scalar", T: 9 /* ScalarType.STRING */ },
 ...
 *
 * @generated from message sunrise.cron.v1.MsgAddScheduleResponse
 */
export class MsgAddScheduleResponse extends Message<MsgAddScheduleResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "sunrise.cron.v1.MsgAddScheduleResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ]);
...
export class MsgRemoveSchedule extends Message<MsgRemoveSchedule> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "sunrise.cron.v1.MsgRemoveSchedule";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "authority", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "name", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);
 ...
 *
 * @generated from message sunrise.cron.v1.MsgRemoveScheduleResponse
 */
export class MsgRemoveScheduleResponse extends Message<MsgRemoveScheduleResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "sunrise.cron.v1.MsgRemoveScheduleResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ]);
