...
/**
 * @generated from rpc pryzm.amm.v1.Query.SimulateRecoveryExit
 */
export const QuerySimulateRecoveryExitService = {
  typeName: TYPE_NAME,
  method: "SimulateRecoveryExit",
  Request: QuerySimulateRecoveryExitRequest,
  Response: QuerySimulateRecoveryExitResponse,
} as const;
