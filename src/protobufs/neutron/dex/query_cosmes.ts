 ...
 *
 * @generated from rpc neutron.dex.Query.SimulateWithdrawalWithShares
 */
export const QuerySimulateWithdrawalWithSharesService = {
  typeName: TYPE_NAME,
  method: "SimulateWithdrawalWithShares",
