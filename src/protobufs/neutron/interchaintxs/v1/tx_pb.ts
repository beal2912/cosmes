...
import { Order } from "../../../ibc/core/channel/v1/channel_pb.js";
...
export class MsgRegisterInterchainAccount extends Message<MsgRegisterInterchainAccount> {
  ...
  /**
   * @generated from field: ibc.core.channel.v1.Order ordering = 5;
   */
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 5, name: "ordering", kind: "enum", T: proto3.getEnumType(Order) },
  ]);
