...
// @generated from file eth/types/v1/account.proto (package eth.types.v1, syntax proto3)
/* eslint-disable */
// @ts-nocheck
 ...
 *
 * @generated from message eth.types.v1.EthAccount
 */
export class EthAccount extends Message<EthAccount> {
  ...
  static readonly typeName = "eth.types.v1.EthAccount";
