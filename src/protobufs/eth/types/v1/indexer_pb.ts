...
// @generated from file eth/types/v1/indexer.proto (package eth.types.v1, syntax proto3)
/* eslint-disable */
// @ts-nocheck
 ...
 *
 * @generated from message eth.types.v1.TxResult
 */
export class TxResult extends Message<TxResult> {
  ...
  static readonly typeName = "eth.types.v1.TxResult";
