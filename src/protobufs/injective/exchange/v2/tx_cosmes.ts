 ...
 *
 * @generated from rpc injective.exchange.v2.Msg.OffsetPosition
 */
export const MsgOffsetPositionService = {
  typeName: TYPE_NAME,
  method: "OffsetPosition",
  Request: MsgOffsetPosition,
  Response: MsgOffsetPositionResponse,
} as const;
...
/**
 * @generated from rpc injective.exchange.v2.Msg.CancelPostOnlyMode
 */
export const MsgCancelPostOnlyModeService = {
  typeName: TYPE_NAME,
  method: "CancelPostOnlyMode",
  Request: MsgCancelPostOnlyMode,
  Response: MsgCancelPostOnlyModeResponse,
} as const;
