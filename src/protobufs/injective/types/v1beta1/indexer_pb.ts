...
// @generated from file injective/types/v1beta1/indexer.proto (package injective.types.v1beta1, syntax proto3)
/* eslint-disable */
// @ts-nocheck
 ...
 *
 * @generated from message injective.types.v1beta1.TxResult
 */
export class TxResult extends Message<TxResult> {
  ...
  static readonly typeName = "injective.types.v1beta1.TxResult";
