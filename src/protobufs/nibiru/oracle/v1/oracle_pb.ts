...
/**
 * @generated from message nibiru.oracle.v1.ExchangeRateAtBlock
 */
export class ExchangeRateAtBlock extends Message<ExchangeRateAtBlock> {
  /**
   ...
   *
   * @generated from field: int64 block_timestamp_ms = 3;
   */
  blockTimestampMs = protoInt64.zero;

  constructor(data?: PartialMessage<ExchangeRateAtBlock>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "nibiru.oracle.v1.ExchangeRateAtBlock";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "exchange_rate", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "created_block", kind: "scalar", T: 4 /* ScalarType.UINT64 */ },
    { no: 3, name: "block_timestamp_ms", kind: "scalar", T: 3 /* ScalarType.INT64 */ },
  ]);

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): ExchangeRateAtBlock {
    return new ExchangeRateAtBlock().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): ExchangeRateAtBlock {
    return new ExchangeRateAtBlock().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): ExchangeRateAtBlock {
    return new ExchangeRateAtBlock().fromJsonString(jsonString, options);
  }

  static equals(a: ExchangeRateAtBlock | PlainMessage<ExchangeRateAtBlock> | undefined, b: ExchangeRateAtBlock | PlainMessage<ExchangeRateAtBlock> | undefined): boolean {
    return proto3.util.equals(ExchangeRateAtBlock, a, b);
  }
}
...
export class Rewards extends Message<Rewards> {
  ...
  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): Rewards {
    return new Rewards().fromJsonString(jsonString, options);
  }

  static equals(a: Rewards | PlainMessage<Rewards> | undefined, b: Rewards | PlainMessage<Rewards> | undefined): boolean {
