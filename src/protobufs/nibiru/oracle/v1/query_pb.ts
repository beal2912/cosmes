...
export class QueryExchangeRateResponse extends Message<QueryExchangeRateResponse> {
   ...
   *
   * @generated from field: int64 block_timestamp_ms = 2;
   */
   ...
   *
   * @generated from field: bool is_vintage = 4;
   */
  isVintage = false;
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 2, name: "block_timestamp_ms", kind: "scalar", T: 3 /* ScalarType.INT64 */ },
    { no: 3, name: "block_height", kind: "scalar", T: 4 /* ScalarType.UINT64 */ },
    { no: 4, name: "is_vintage", kind: "scalar", T: 8 /* ScalarType.BOOL */ },
  ]);
