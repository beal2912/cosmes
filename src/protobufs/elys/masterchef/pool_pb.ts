...
export class PoolInfo extends Message<PoolInfo> {
   ...
   *
   * @generated from field: bool enable_eden_rewards = 9;
   */
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 9, name: "enable_eden_rewards", kind: "scalar", T: 8 /* ScalarType.BOOL */ },
  ]);
...
/**
 * @generated from message elys.masterchef.LegacyPoolInfo
 */
export class LegacyPoolInfo extends Message<LegacyPoolInfo> {
  /**
   * @generated from field: uint64 pool_id = 1;
   */
  poolId = protoInt64.zero;
  ...
  constructor(data?: PartialMessage<LegacyPoolInfo>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "elys.masterchef.LegacyPoolInfo";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "pool_id", kind: "scalar", T: 4 /* ScalarType.UINT64 */ },
    { no: 2, name: "reward_wallet", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 3, name: "multiplier", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ...
  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): LegacyPoolInfo {
    return new LegacyPoolInfo().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): LegacyPoolInfo {
    return new LegacyPoolInfo().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): LegacyPoolInfo {
    return new LegacyPoolInfo().fromJsonString(jsonString, options);
  }

  static equals(a: LegacyPoolInfo | PlainMessage<LegacyPoolInfo> | undefined, b: LegacyPoolInfo | PlainMessage<LegacyPoolInfo> | undefined): boolean {
    return proto3.util.equals(LegacyPoolInfo, a, b);
  }
}
